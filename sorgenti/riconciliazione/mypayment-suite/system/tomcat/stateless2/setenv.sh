...
CATALINA_PID=/var/run/mypay/stateless.pid
	...
	JAVA_OPTS="$JAVA_OPTS -XX:-HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=../logs/java_OOM_DUMP.`date +"%s"`.hprof"
        ...
        #
        JAVA_OPTS="$JAVA_OPTS -DJVMROUTE=__TAG_SYSTEM_MYPAY_TOMCAT_STATELESS2_JVMROUTE__"
        JAVA_OPTS="$JAVA_OPTS -DBIND_ADDRESS=__TAG_SYSTEM_MYPAY_TOMCAT_STATELESS2_ADDRESS__"
        #
	##
	## STATELESS : Traslare le porte di +10000
        JAVA_OPTS="$JAVA_OPTS -DSHUTDOWN_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATELESS2_SHUTDOWN_PORT__"
	#
        JAVA_OPTS="$JAVA_OPTS -DAJP_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATELESS2_AJP_PORT__"
        ...
        #
        JAVA_OPTS="$JAVA_OPTS -DHTTP_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATELESS2_HTTP_PORT__"
        ...
        #
        JAVA_OPTS="$JAVA_OPTS -DHTTPS_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATELESS2_HTTPS_PORT__"
