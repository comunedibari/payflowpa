...
CATALINA_PID=/var/run/mypay/stateful.pid
	...
	JAVA_OPTS="$JAVA_OPTS -XX:-HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=../logs/java_OOM_DUMP.`date +"%s"`.hprof"
        ...
        #
        JAVA_OPTS="$JAVA_OPTS -DJVMROUTE=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_JVMROUTE__"
        JAVA_OPTS="$JAVA_OPTS -DBIND_ADDRESS=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_ADDRESS__"
        #
	## CLUSTER - ATTEVARE SOLO CASO STATEFULL ##
	JAVA_OPTS="$JAVA_OPTS -DMCAST_BIND_ADDRESS=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_MCAST_BIND_ADDRESS__ "
	JAVA_OPTS="$JAVA_OPTS -DMCAST_BIND_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_MCAST_BIND_PORT__"
	JAVA_OPTS="$JAVA_OPTS -DRECEIVER_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_MCAST_BIND_RECEIVER_PORT__"
	JAVA_OPTS="$JAVA_OPTS -DRECEIVER_AUTOBIND=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_MCAST_BIND_RECEIVER_AUTOBIND__"
	##
	## STATEFUL : Porte Standard
        JAVA_OPTS="$JAVA_OPTS -DSHUTDOWN_PORT=8005"
	#
        JAVA_OPTS="$JAVA_OPTS -DAJP_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_AJP_PORT__"
        ...
        #
        JAVA_OPTS="$JAVA_OPTS -DHTTP_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_HTTP_PORT__"
        ...
        #
        JAVA_OPTS="$JAVA_OPTS -DHTTPS_PORT=__TAG_SYSTEM_MYPAY_TOMCAT_STATEFUL1_HTTPS_PORT__"
