		...
		<div class="body clearfix">
			<div class="clearfix">
				<div style="text-align: center;">
					<img alt="500" src="<%=request.getContextPath()%>/images/500.jpg"
						title="500">
				</div>
				<div class="alert alert-error myAlert">
					<i class="fa fa-exclamation-circle fa-2x pull-left"></i> Siamo spiacenti, si è verificato un errore inatteso.
				</div>
			</div>
		</div>
