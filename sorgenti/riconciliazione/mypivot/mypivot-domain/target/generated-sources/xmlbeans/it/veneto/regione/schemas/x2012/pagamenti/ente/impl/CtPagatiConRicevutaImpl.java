 ...
 */
public class CtPagatiConRicevutaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.veneto.regione.schemas.x2012.pagamenti.ente.CtPagatiConRicevuta
{
    
    public CtPagatiConRicevutaImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiVersamentoPagatiConRicevuta getDatiPagamento()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiVersamentoPagatiConRicevuta target = null;
            target = (it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiVersamentoPagatiConRicevuta)get_store().find_element_user(DATIPAGAMENTO$18, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setDatiPagamento(it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiVersamentoPagatiConRicevuta datiPagamento)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiVersamentoPagatiConRicevuta)get_store().add_element_user(DATIPAGAMENTO$18);
            }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiVersamentoPagatiConRicevuta addNewDatiPagamento()
    {
        synchronized (monitor())
        {
            check_orphaned();
