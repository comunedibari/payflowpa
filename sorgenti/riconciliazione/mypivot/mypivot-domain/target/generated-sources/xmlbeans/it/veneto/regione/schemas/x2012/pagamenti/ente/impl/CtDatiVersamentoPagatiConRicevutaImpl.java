 ...
 */
public class CtDatiVersamentoPagatiConRicevutaImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiVersamentoPagatiConRicevuta
{
    
    public CtDatiVersamentoPagatiConRicevutaImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta[] getDatiSingoloPagamentoArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta[] result = new it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta[targetList.size()];
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta getDatiSingoloPagamentoArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta target = null;
            target = (it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta)get_store().find_element_user(DATISINGOLOPAGAMENTO$8, i);
            if (target == null)
            {
     ...
     */
    public void setDatiSingoloPagamentoArray(it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta[] datiSingoloPagamentoArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setDatiSingoloPagamentoArray(int i, it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta datiSingoloPagamento)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta insertNewDatiSingoloPagamento(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta target = null;
            target = (it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta)get_store().insert_element_user(DATISINGOLOPAGAMENTO$8, i);
            return target;
        }
    }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta addNewDatiSingoloPagamento()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta target = null;
            target = (it.veneto.regione.schemas.x2012.pagamenti.ente.CtDatiSingoloPagamentoPagatiConRicevuta)get_store().add_element_user(DATISINGOLOPAGAMENTO$8);
            return target;
        }
    }
