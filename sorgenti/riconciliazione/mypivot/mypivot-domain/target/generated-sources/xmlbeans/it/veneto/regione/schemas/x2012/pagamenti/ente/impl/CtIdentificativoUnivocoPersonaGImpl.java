 ...
 */
public class CtIdentificativoUnivocoPersonaGImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.veneto.regione.schemas.x2012.pagamenti.ente.CtIdentificativoUnivocoPersonaG
{
    
    public CtIdentificativoUnivocoPersonaGImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG.Enum getTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            ...
            return (it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG xgetTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG target = null;
            target = (it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG)get_store().find_element_user(TIPOIDENTIFICATIVOUNIVOCO$0, 0);
            return target;
        }
    }
     ...
     */
    public void setTipoIdentificativoUnivoco(it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG.Enum tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTipoIdentificativoUnivoco(it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersG)get_store().add_element_user(TIPOIDENTIFICATIVOUNIVOCO$0);
            }
