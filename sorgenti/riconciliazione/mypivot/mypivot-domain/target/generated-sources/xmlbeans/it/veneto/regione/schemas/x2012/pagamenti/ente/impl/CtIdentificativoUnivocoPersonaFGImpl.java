 ...
 */
public class CtIdentificativoUnivocoPersonaFGImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.veneto.regione.schemas.x2012.pagamenti.ente.CtIdentificativoUnivocoPersonaFG
{
    
    public CtIdentificativoUnivocoPersonaFGImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG.Enum getTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            ...
            return (it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG xgetTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG target = null;
            target = (it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG)get_store().find_element_user(TIPOIDENTIFICATIVOUNIVOCO$0, 0);
            return target;
        }
    }
     ...
     */
    public void setTipoIdentificativoUnivoco(it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG.Enum tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTipoIdentificativoUnivoco(it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.veneto.regione.schemas.x2012.pagamenti.ente.StTipoIdentificativoUnivocoPersFG)get_store().add_element_user(TIPOIDENTIFICATIVOUNIVOCO$0);
            }
