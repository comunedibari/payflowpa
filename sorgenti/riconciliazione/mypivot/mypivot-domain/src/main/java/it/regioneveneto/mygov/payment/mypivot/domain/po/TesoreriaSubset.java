...
/**
 * TesoreriaSubset generated by hbm2java
 */
@Entity
@Table(name = "mygov_import_export_rendicontazione_tesoreria")
public class TesoreriaSubset implements java.io.Serializable {

	private TesoreriaSubsetId id;
	...
	public TesoreriaSubset() {
	}

	public TesoreriaSubset(TesoreriaSubsetId id) {
		this.id = id;
	}

	public TesoreriaSubset(TesoreriaSubsetId id, Date dtDataEsecuzionePagamento, String deDataEsecuzionePagamento,
			String singoloImportoCommissioneCaricoPa, String bilancio, String codConto, Date dtDataContabile,
			...
			String deDataUltimoAggiornamento, String codIufKey, String codIuvKey) {
		this.id = id;
	...
	public TesoreriaSubsetId getId() {
		return this.id;
	}

	public void setId(TesoreriaSubsetId id) {
		this.id = id;
	}
