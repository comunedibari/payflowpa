...
/**
 * Bean che mappa la form della statistica: Totale per Uffici.
 * 
 * @author Marianna Memoli
 */
public class CruscottoIncassiUfficiInputDto extends CruscottoIncassiInputDto {
	...
	public String toString() {
		...
		builder.append("CruscottoIncassiUfficiCommand [anno=");
		builder.append(anno);
		builder.append(", mese=");
		builder.append(mese);
