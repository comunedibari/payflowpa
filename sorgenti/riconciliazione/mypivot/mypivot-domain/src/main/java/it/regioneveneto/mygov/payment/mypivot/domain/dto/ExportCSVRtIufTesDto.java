...
public class ExportCSVRtIufTesDto implements ExportCSVDtoIFace {
	...
	public String getNumeroImporto() {
		return numeroImporto;
	}
	public void setNumeroImporto(String numeroImporto) {
		this.numeroImporto = numeroImporto;
	}
