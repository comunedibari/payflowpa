...
/**
 * ImportExportRendicontazioneTesoreria generated by hbm2java
 */
@Entity
@Table(name = "mygov_import_export_rendicontazione_tesoreria")
public class ImportExportRendicontazioneTesoreria implements java.io.Serializable {

	private ImportExportRendicontazioneTesoreriaId id;
	...
	public ImportExportRendicontazioneTesoreria() {
	}

	public ImportExportRendicontazioneTesoreria(ImportExportRendicontazioneTesoreriaId id) {
		this.id = id;
	}

	public ImportExportRendicontazioneTesoreria(ImportExportRendicontazioneTesoreriaId id,
			Date dtDataEsecuzionePagamento, String deDataEsecuzionePagamento, String singoloImportoCommissioneCaricoPa,
			String bilancio, String nomeFlussoImportEnte, String rigaFlussoImportEnte, String codiceIud,
			String versioneOggetto, String identificativoDominio, String identificativoStazioneRichiedente,
			String identificativoMessaggioRicevuta, String dataOraMessaggioRicevuta,
			String riferimentoMessaggioRichiesta, String riferimentoDataRichiesta,
			String tipoIdentificativoUnivocoAttestante, String codiceIdentificativoUnivocoAttestante,
			String denominazioneAttestante, String codiceUnitOperAttestante, String denomUnitOperAttestante,
			String indirizzoAttestante, String civicoAttestante, String capAttestante, String localitaAttestante,
			String provinciaAttestante, String nazioneAttestante, String tipoIdentificativoUnivocoBeneficiario,
			String codiceIdentificativoUnivocoBeneficiario, String denominazioneBeneficiario,
			String codiceUnitOperBeneficiario, String denomUnitOperBeneficiario, String indirizzoBeneficiario,
			String civicoBeneficiario, String capBeneficiario, String localitaBeneficiario,
			String provinciaBeneficiario, String nazioneBeneficiario, String tipoIdentificativoUnivocoVersante,
			String codiceIdentificativoUnivocoVersante, String anagraficaVersante, String indirizzoVersante,
			String civicoVersante, String capVersante, String localitaVersante, String provinciaVersante,
			String nazioneVersante, String emailVersante, String tipoIdentificativoUnivocoPagatore,
			String codiceIdentificativoUnivocoPagatore, String anagraficaPagatore, String indirizzoPagatore,
			String civicoPagatore, String capPagatore, String localitaPagatore, String provinciaPagatore,
			String nazionePagatore, String emailPagatore, String codiceEsitoPagamento, String importoTotalePagato,
			String identificativoUnivocoVersamento, String codiceContestoPagamento, String singoloImportoPagato,
			String esitoSingoloPagamento, Date dtDataEsitoSingoloPagamento, String deDataEsitoSingoloPagamento,
			String causaleVersamento, String datiSpecificiRiscossione, String tipoDovuto,
			String dataOraFlussoRendicontazione, String identificativoUnivocoRegolamento, Date dtDataRegolamento,
			String deDataRegolamento, String numeroTotalePagamenti, String importoTotalePagamenti,
			String dataAcquisizione, String codConto, Date dtDataContabile, String deDataContabile, Date dtDataValuta,
			String deDataValuta, BigDecimal numImporto, String deImporto, String codOr1, String deAnnoBolletta,
			String codBolletta, String codIdDominio, Date dtRicezione, String deDataRicezione, String deAnnoDocumento,
			String codDocumento, String deAnnoProvvisorio, String codProvvisorio, String deCausaleT,
			String verificaTotale, Date dtDataUltimoAggiornamento, String deDataUltimoAggiornamento,
			Integer indiceDatiSingoloPagamento, String codIufKey, String codIudKey, String codIuvKey,
			String bilancioE,
	...
	@AttributeOverrides({
			...
			@AttributeOverride(name = "classificazioneCompletezza", column = @Column(name = "classificazione_completezza", length = 20)) })
	public ImportExportRendicontazioneTesoreriaId getId() {
		return this.id;
	}

	public void setId(ImportExportRendicontazioneTesoreriaId id) {
		this.id = id;
	}
	...
	@Column(name = "provincia_beneficiario", length = 35)
	...
	@Column(name = "cod_iud_key", length = 35)
	public String getCodIudKey() {
		return this.codIudKey;
	}
	...
	@Column(name = "cod_iuv_key", length = 35)
	public String getCodIuvKey() {
		return this.codIuvKey;
	}
	...
	@Column(name = "bilancio_e", length = 4096)
	public String getBilancioE() {
		return this.bilancioE;
	}
