...
public class TesoreriaSubsetTO  implements java.io.Serializable {

    public TesoreriaSubsetIdTO id;
    ...
    protected TesoreriaSubsetTO() {
    }

    public TesoreriaSubsetTO(TesoreriaSubsetIdTO id, String bilancio, String classificazioneCompletezza, String codBolletta, String codConto, String codDocumento, String codIdDominio, String codIufKey, String codIuvKey, String codOr1, String codProvvisorio, String deAnnoBolletta, String deAnnoDocumento, String deAnnoProvvisorio, String deCausaleT, String deDataContabile, String deDataEsecuzionePagamento, String deDataRicezione, String deDataUltimoAggiornamento, String deDataValuta, String deImporto, Date dtDataContabile, Date dtDataEsecuzionePagamento, Date dtDataUltimoAggiornamento, Date dtDataValuta, Date dtRicezione, BigDecimal numImporto, String singoloImportoCommissioneCaricoPa) {
        super();
        this.id = id;
    ...
    public static TesoreriaSubsetTO copyOf(TesoreriaSubsetTO o) {
            return new it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO(
                it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetIdTO.copyOf(((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).id),
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).bilancio,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).classificazioneCompletezza,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codBolletta,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codConto,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codDocumento,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codIdDominio,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codIufKey,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codIuvKey,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codOr1,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).codProvvisorio,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deAnnoBolletta,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deAnnoDocumento,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deAnnoProvvisorio,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deCausaleT,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deDataContabile,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deDataEsecuzionePagamento,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deDataRicezione,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deDataUltimoAggiornamento,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deDataValuta,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).deImporto,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).dtDataContabile,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).dtDataEsecuzionePagamento,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).dtDataUltimoAggiornamento,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).dtDataValuta,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).dtRicezione,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).numImporto,
                ((it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO) o).singoloImportoCommissioneCaricoPa
                );
    }

    public TesoreriaSubsetIdTO getId() {
        return id;
    }

    public void setId(TesoreriaSubsetIdTO id) {
        this.id = id;
    }
    ...
    public TesoreriaSubsetTO copy() {
        return it.regioneveneto.mygov.payment.mypivot.domain.to.TesoreriaSubsetTO.copyOf(this);
    }
