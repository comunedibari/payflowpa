...
-- Started on 2018-10-18 10:21:30 CEST
...
--
-- TOC entry 1 (class 3079 OID 12535)
...
--
-- TOC entry 253 (class 1255 OID 4359308)
-- Name: get_count_flusso_rendicontazione_function(bigint, date, date, character varying, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_count_flusso_rendicontazione_function(_mygov_ente_id bigint, _dt_data_regolamento_da date, _dt_data_regolamento_a date, _cod_iuf character varying, _identificativo_univoco_regolamento character varying) RETURNS bigint
    LANGUAGE sql STABLE
    AS $$
...
COMMENT ON FUNCTION get_count_pagamenti_inseribili_in_accertamento(_ente_id bigint, _cod_tipo_dovuto character varying, _codice_iud character varying, _codice_iuv character varying, _codice_identificativo_univoco_pagatore character varying, _data_esito_singolo_pagamento_da date, _data_esito_singolo_pagamento_a date, _data_ultimo_aggiornamento_da date, _data_ultimo_aggiornamento_a date) IS 'Count dei Pagamenti inseribili in accertamento';


--
-- TOC entry 255 (class 1255 OID 4365168)
-- Name: get_count_pagamenti_inseriti_in_accertamento(bigint, bigint, character varying, character varying, character varying, character varying, date, date, date, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_count_pagamenti_inseriti_in_accertamento(_accertamento_id bigint, _ente_id bigint, _cod_tipo_dovuto character varying, _codice_iud character varying, _codice_iuv character varying, _codice_identificativo_univoco_pagatore character varying, _data_esito_singolo_pagamento_da date, _data_esito_singolo_pagamento_a date, _data_ultimo_aggiornamento_da date, _data_ultimo_aggiornamento_a date) RETURNS bigint
    LANGUAGE sql
    AS $_$
  SELECT 
...
--
-- TOC entry 261 (class 1255 OID 4359305)
-- Name: get_count_rendicontazione_tesoreria_subset_function(character varying, character varying, character varying, date, date, date, date, date, date, date, date, text, character varying, character varying, character varying, character varying, boolean, character varying, boolean, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_count_rendicontazione_tesoreria_subset_function(_codice_ipa_ente character varying, _identificativo_flusso_rendicontazione character varying, _identificativo_univoco_regolamento character varying, _dt_data_regolamento_da date, _dt_data_regolamento_a date, _dt_data_contabile_da date, _dt_data_contabile_a date, _dt_data_valuta_da date, _dt_data_valuta_a date, _dt_data_ultimo_aggiornamento_da date, _dt_data_ultimo_aggiornamento_a date, _de_causale_t text, _importo character varying, _conto character varying, _codor1 character varying, _cod_tipo_dovuto character varying, _is_cod_tipo_dovuto_present boolean, _cod_fed_user_id character varying, _flagnascosto boolean, _classificazione_completezza character varying) RETURNS bigint
    LANGUAGE sql STABLE
    AS $$
   SELECT 
...
--
-- TOC entry 256 (class 1255 OID 4359296)
-- Name: get_count_tesoreria_no_match_subset_function(character varying, date, date, date, date, date, date, text, character varying, character varying, character varying, boolean, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_count_tesoreria_no_match_subset_function(_codice_ipa_ente character varying, _dt_data_contabile_da date, _dt_data_contabile_a date, _dt_data_valuta_da date, _dt_data_valuta_a date, _dt_data_ultimo_aggiornamento_da date, _dt_data_ultimo_aggiornamento_a date, _de_causale_t text, _importo character varying, _conto character varying, _codor1 character varying, _flagnascosto boolean, _classificazione_completezza character varying) RETURNS bigint
    LANGUAGE sql STABLE
    AS $$
...
--
-- TOC entry 257 (class 1255 OID 4365165)
-- Name: get_count_tesoreria_subset_function(character varying, date, date, date, date, date, date, text, character varying, character varying, character varying, boolean, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_count_tesoreria_subset_function(_codice_ipa_ente character varying, _dt_data_contabile_da date, _dt_data_contabile_a date, _dt_data_valuta_da date, _dt_data_valuta_a date, _dt_data_ultimo_aggiornamento_da date, _dt_data_ultimo_aggiornamento_a date, _de_causale_t text, _importo character varying, _conto character varying, _codor1 character varying, _flagnascosto boolean, _classificazione_completezza character varying, _cod_iuv character varying, _cod_iuf character varying) RETURNS bigint
    LANGUAGE sql STABLE
    AS $$
   SELECT COUNT(1)
   FROM 
...
--
-- TOC entry 260 (class 1255 OID 4413181)
-- Name: get_dettaglio_pagamenti_cruscotto(integer, integer, integer, character varying, character varying, character varying, bigint, character varying); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_dettaglio_pagamenti_cruscotto(_anno integer, _mese integer, _giorno integer, _cod_ufficio character varying, _cod_dovuto character varying, _cod_capitolo character varying, _ente_id bigint, _cod_accertamento character varying) RETURNS SETOF character varying
    LANGUAGE sql STABLE
    AS $_$
...
--
-- TOC entry 217 (class 1259 OID 4359210)
-- Name: mygov_import_export_rendicontazione_tesoreria; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 246 (class 1255 OID 4359293)
-- Name: get_import_export_rend_tes_function(character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying, date, date, date, date, character varying, character varying, date, date, date, date, date, date, date, date, character varying, boolean, character varying, character varying, character varying, boolean, character varying, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION get_import_export_rend_tes_function(_cod_fed_user_id character varying, _codice_ipa_ente character varying, _cod_iud character varying, _cod_iuv character varying, _denominazione_attestante character varying, _identificativo_univoco_riscossione character varying, _codice_identificativo_univoco_versante character varying, _anagrafica_versante character varying, _codice_identificativo_univoco_pagatore character varying, _anagrafica_pagatore character varying, _causale_versamento character varying, _data_esecuzione_singolo_pagamento_da date, _data_esecuzione_singolo_pagamento_a date, _data_esito_singolo_pagamento_da date, _data_esito_singolo_pagamento_a date, _identificativo_flusso_rendicontazione character varying, _identificativo_univoco_regolamento character varying, _data_regolamento_da date, _data_regolamento_a date, _dt_data_contabile_da date, _dt_data_contabile_a date, _dt_data_valuta_da date, _dt_data_valuta_a date, _dt_data_ultimo_aggiornamento_da date, _dt_data_ultimo_aggiornamento_a date, _cod_tipo_dovuto character varying, _is_cod_tipo_dovuto_present boolean, _importo character varying, _conto character varying, _codor1 character varying, _flagnascosto boolean, _classificazione_completezza character varying, _page integer, _size integer) RETURNS SETOF mygov_import_export_rendicontazione_tesoreria
    LANGUAGE sql STABLE
    AS $$
   SELECT 
      tes.*
...
--
-- TOC entry 259 (class 1255 OID 4116055)
...
--
-- TOC entry 245 (class 1255 OID 4116056)
-- Name: inserisci_richiesta_flusso_rendicontazione(bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION inserisci_richiesta_flusso_rendicontazione(mygov_ente_id_n bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
    DECLARE
...
--
-- TOC entry 214 (class 1259 OID 4169367)
-- Name: mygov_accertamento; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 220 (class 1259 OID 4359257)
-- Name: mygov_accertamento_dettaglio; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 221 (class 1259 OID 4359273)
-- Name: mygov_accertamento_dettaglio_mygov_accertamento_dett_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- TOC entry 213 (class 1259 OID 4169363)
-- Name: mygov_accertamento_mygov_accertamento_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- TOC entry 219 (class 1259 OID 4359253)
-- Name: mygov_anag_uff_cap_acc_mygov_anag_uff_cap_acc_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- TOC entry 171 (class 1259 OID 4116057)
-- Name: mygov_anagrafica_stato; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 172 (class 1259 OID 4116060)
...
--
-- TOC entry 218 (class 1259 OID 4359240)
-- Name: mygov_anagrafica_uff_cap_acc; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 173 (class 1259 OID 4116062)
-- Name: mygov_classificazione_completezza; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 174 (class 1259 OID 4116065)
-- Name: mygov_ente; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 175 (class 1259 OID 4116074)
-- Name: mygov_ente_flusso_rendicon_mygov_ente_flusso_rendicon_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mygov_ente_flusso_rendicon_mygov_ente_flusso_rendicon_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 176 (class 1259 OID 4116076)
-- Name: mygov_ente_flusso_rendicontazione; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE mygov_ente_flusso_rendicontazione (
...
--
-- TOC entry 177 (class 1259 OID 4116082)
...
-- Dependencies: 177
-- Name: mygov_ente_mygov_ente_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mygov_ente_mygov_ente_id_seq OWNED BY mygov_ente.mygov_ente_id;


--
-- TOC entry 178 (class 1259 OID 4116084)
-- Name: mygov_ente_prenotazione; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 179 (class 1259 OID 4116090)
...
--
-- TOC entry 180 (class 1259 OID 4116092)
-- Name: mygov_ente_tipo_dovuto; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 181 (class 1259 OID 4116095)
-- Name: mygov_ente_tipo_dovuto_mygov_ente_tipo_dovuto_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
-- Dependencies: 181
-- Name: mygov_ente_tipo_dovuto_mygov_ente_tipo_dovuto_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mygov_ente_tipo_dovuto_mygov_ente_tipo_dovuto_id_seq OWNED BY mygov_ente_tipo_dovuto.mygov_ente_tipo_dovuto_id;


--
-- TOC entry 182 (class 1259 OID 4116097)
-- Name: mygov_entepsp; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 183 (class 1259 OID 4116100)
-- Name: mygov_entepsp_flusso_rendicontazione; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 184 (class 1259 OID 4116106)
...
--
-- TOC entry 185 (class 1259 OID 4116108)
...
--
-- TOC entry 190 (class 1259 OID 4116125)
-- Name: mygov_export_rendicontazione_completa; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE mygov_export_rendicontazione_completa (
...
--
-- TOC entry 191 (class 1259 OID 4116131)
-- Name: mygov_flusso_export; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 192 (class 1259 OID 4116137)
-- Name: mygov_flusso_import; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 193 (class 1259 OID 4116143)
-- Name: mygov_flusso_rendicontazione; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 196 (class 1259 OID 4116158)
-- Name: mygov_flusso_tesoreria; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 194 (class 1259 OID 4116146)
-- Name: mygov_flusso_tesoreria_iuf; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE mygov_flusso_tesoreria_iuf (
    version integer NOT NULL,
    dt_creazione timestamp without time zone NOT NULL,
    dt_ultima_modifica timestamp without time zone NOT NULL,
    mygov_ente_id bigint NOT NULL,
...
--
-- TOC entry 195 (class 1259 OID 4116152)
-- Name: mygov_flusso_tesoreria_iuv; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE mygov_flusso_tesoreria_iuv (
    version integer NOT NULL,
    dt_creazione timestamp without time zone NOT NULL,
    dt_ultima_modifica timestamp without time zone NOT NULL,
    mygov_ente_id bigint NOT NULL,
...
--
-- TOC entry 197 (class 1259 OID 4116164)
-- Name: mygov_flusso_tesoreria_mygov_flusso_tesoreria_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- TOC entry 215 (class 1259 OID 4359197)
-- Name: mygov_import_export_rendicontazione_tesoreria_completa; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 198 (class 1259 OID 4116178)
-- Name: mygov_info_flusso_poste_web; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE mygov_info_flusso_poste_web (
...
--
-- TOC entry 199 (class 1259 OID 4116181)
-- Name: mygov_info_flusso_poste_web_mygov_info_flusso_poste_web_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mygov_info_flusso_poste_web_mygov_info_flusso_poste_web_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
-- Dependencies: 199
-- Name: mygov_info_flusso_poste_web_mygov_info_flusso_poste_web_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE mygov_info_flusso_poste_web_mygov_info_flusso_poste_web_id_seq OWNED BY mygov_info_flusso_poste_web.mygov_info_flusso_poste_web_id;


--
-- TOC entry 222 (class 1259 OID 4359275)
-- Name: mygov_info_mapping_tesoreria; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 223 (class 1259 OID 4359285)
-- Name: mygov_info_mapping_tesoreria_mygov_info_mapping_tes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- TOC entry 200 (class 1259 OID 4116183)
-- Name: mygov_manage_flusso; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 201 (class 1259 OID 4116190)
...
--
-- TOC entry 186 (class 1259 OID 4116110)
-- Name: mygov_op_ente_tipo_dovuto_mygov_op_ente_tipo_dovuto_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- TOC entry 187 (class 1259 OID 4116112)
-- Name: mygov_operatore_ente_tipo_dovuto; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 202 (class 1259 OID 4116192)
-- Name: mygov_pren_flus_ric_mygov_pren_flus_ric_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mygov_pren_flus_ric_mygov_pren_flus_ric_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 203 (class 1259 OID 4116194)
-- Name: mygov_pren_flusso_rend_ente_mygov_pren_flusso_rend_ente_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE mygov_pren_flusso_rend_ente_mygov_pren_flusso_rend_ente_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- TOC entry 204 (class 1259 OID 4116196)
-- Name: mygov_prenotazione_flusso_rendicontazione; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 205 (class 1259 OID 4116199)
...
--
-- TOC entry 206 (class 1259 OID 4116201)
-- Name: mygov_prenotazione_flusso_rendicontazione_ente; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE mygov_prenotazione_flusso_rendicontazione_ente (
    mygov_prenotazione_flusso_rendicontazione_ente_id bigint NOT NULL,
    version integer NOT NULL,
    mygov_ente_id bigint NOT NULL,
    mygov_anagrafica_stato_id bigint NOT NULL,
...
--
-- TOC entry 207 (class 1259 OID 4116204)
-- Name: mygov_prenotazione_flusso_riconciliazione; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE mygov_prenotazione_flusso_riconciliazione (
...
--
-- TOC entry 188 (class 1259 OID 4116115)
-- Name: mygov_segnalazione; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 189 (class 1259 OID 4116123)
-- Name: mygov_segnalazione_mygov_segnalazione_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- TOC entry 208 (class 1259 OID 4116210)
-- Name: mygov_tipo_flusso; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 209 (class 1259 OID 4116213)
...
--
-- TOC entry 210 (class 1259 OID 4116215)
-- Name: mygov_utente; Type: TABLE; Schema: public; Owner: -
--
...
--
-- TOC entry 211 (class 1259 OID 4116221)
...
--
-- TOC entry 212 (class 1259 OID 4116223)
-- Name: v_mygov_export_rendicontazione_completa; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW v_mygov_export_rendicontazione_completa AS
...
--
-- TOC entry 216 (class 1259 OID 4359205)
-- Name: v_mygov_import_export_rendicontazione_tesoreria; Type: VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 232 (class 1259 OID 4422675)
-- Name: v_mygov_import_export_rendicontazione_tesoreria_completa; Type: VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 224 (class 1259 OID 4413117)
-- Name: vm_statistica_ente_anno_mese; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
   ...
   FROM ( SELECT mygov_flusso_export.mygov_ente_id,
        ...
        UNION
         SELECT mygov_import_export_rendicontazione_tesoreria_completa.mygov_ente_id,
            ...
            0 AS imp_inc
           FROM mygov_import_export_rendicontazione_tesoreria_completa
...
--
-- TOC entry 225 (class 1259 OID 4413125)
-- Name: vm_statistica_ente_anno_mese_giorno; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 226 (class 1259 OID 4413133)
-- Name: vm_statistica_ente_anno_mese_giorno_uff_td; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 228 (class 1259 OID 4413149)
-- Name: vm_statistica_ente_anno_mese_giorno_uff_td_cap; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 230 (class 1259 OID 4413165)
-- Name: vm_statistica_ente_anno_mese_giorno_uff_td_cap_acc; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 227 (class 1259 OID 4413141)
-- Name: vm_statistica_ente_anno_mese_uff_td; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 229 (class 1259 OID 4413157)
-- Name: vm_statistica_ente_anno_mese_uff_td_cap; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 231 (class 1259 OID 4413173)
-- Name: vm_statistica_ente_anno_mese_uff_td_cap_acc; Type: MATERIALIZED VIEW; Schema: public; Owner: -
--
...
--
-- TOC entry 2955 (class 2606 OID 4359262)
-- Name: mygov_accertamento_dettaglio mygov_accertamento_dettaglio_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_accertamento_dettaglio
    ADD CONSTRAINT mygov_accertamento_dettaglio_pkey PRIMARY KEY (mygov_accertamento_dettaglio_id);


--
-- TOC entry 2931 (class 2606 OID 4169372)
-- Name: mygov_accertamento mygov_accertamento_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_accertamento
    ADD CONSTRAINT mygov_accertamento_pkey PRIMARY KEY (mygov_accertamento_id);


--
-- TOC entry 2862 (class 2606 OID 4116239)
-- Name: mygov_anagrafica_stato mygov_anagrafica_stato_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2951 (class 2606 OID 4359247)
-- Name: mygov_anagrafica_uff_cap_acc mygov_anagrafica_uff_cap_acc_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_anagrafica_uff_cap_acc
    ADD CONSTRAINT mygov_anagrafica_uff_cap_acc_pkey PRIMARY KEY (mygov_anagrafica_uff_cap_acc_id);


--
-- TOC entry 2864 (class 2606 OID 4116241)
-- Name: mygov_classificazione_completezza mygov_classificazione_completezza_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_classificazione_completezza
    ADD CONSTRAINT mygov_classificazione_completezza_pkey PRIMARY KEY (mygov_classificazione_codice);


--
-- TOC entry 2872 (class 2606 OID 4116243)
-- Name: mygov_ente_flusso_rendicontazione mygov_ente_flusso_rendicontazione_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_ente_flusso_rendicontazione
    ADD CONSTRAINT mygov_ente_flusso_rendicontazione_pkey PRIMARY KEY (mygov_ente_flusso_rendicontazione_id);


--
-- TOC entry 2866 (class 2606 OID 4116245)
-- Name: mygov_ente mygov_ente_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2875 (class 2606 OID 4116247)
-- Name: mygov_ente_prenotazione mygov_ente_prenotazione_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2878 (class 2606 OID 4116249)
-- Name: mygov_ente_tipo_dovuto mygov_ente_tipo_dovuto_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2868 (class 2606 OID 4116251)
-- Name: mygov_ente mygov_ente_ukey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2884 (class 2606 OID 4116253)
-- Name: mygov_entepsp_flusso_rendicontazione mygov_entepsp_flusso_rendicontazione_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2880 (class 2606 OID 4116255)
-- Name: mygov_entepsp mygov_entepsp_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2896 (class 2606 OID 4116261)
-- Name: mygov_flusso_export mygov_flusso_export_ente_iuv_iur_idsp_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2898 (class 2606 OID 4116263)
-- Name: mygov_flusso_import mygov_flusso_import_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_flusso_import
    ADD CONSTRAINT mygov_flusso_import_pkey PRIMARY KEY (mygov_ente_id, cod_iud);


--
-- TOC entry 2902 (class 2606 OID 4116265)
-- Name: mygov_flusso_rendicontazione mygov_flusso_rendicontazione_ente_iuv_iur_idsp_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2906 (class 2606 OID 4116267)
-- Name: mygov_flusso_tesoreria_iuv mygov_flusso_tesoreria_ente_iuv_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_flusso_tesoreria_iuv
    ADD CONSTRAINT mygov_flusso_tesoreria_ente_iuv_pkey PRIMARY KEY (mygov_ente_id, cod_id_univoco_versamento);


--
-- TOC entry 2908 (class 2606 OID 4116271)
-- Name: mygov_flusso_tesoreria mygov_flusso_tesoreria_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2904 (class 2606 OID 4116269)
-- Name: mygov_flusso_tesoreria_iuf mygov_flusso_tesoreria_psp_iuf_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2910 (class 2606 OID 4422666)
-- Name: mygov_flusso_tesoreria mygov_flusso_tesoreria_ukey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2912 (class 2606 OID 4116275)
-- Name: mygov_info_flusso_poste_web mygov_info_flusso_poste_web_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2957 (class 2606 OID 4359279)
-- Name: mygov_info_mapping_tesoreria mygov_info_mapping_tesoreria_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_info_mapping_tesoreria
    ADD CONSTRAINT mygov_info_mapping_tesoreria_pkey PRIMARY KEY (mygov_info_mapping_tesoreria_id);


--
-- TOC entry 2915 (class 2606 OID 4116277)
-- Name: mygov_manage_flusso mygov_manage_flusso_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2886 (class 2606 OID 4116257)
-- Name: mygov_operatore_ente_tipo_dovuto mygov_operatore_ente_tipo_dovuto_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_operatore_ente_tipo_dovuto
    ADD CONSTRAINT mygov_operatore_ente_tipo_dovuto_pkey PRIMARY KEY (mygov_operatore_ente_tipo_dovuto_id);


--
-- TOC entry 2925 (class 2606 OID 4116279)
-- Name: mygov_prenotazione_flusso_riconciliazione mygov_pren_flus_ric_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_riconciliazione
    ADD CONSTRAINT mygov_pren_flus_ric_pkey PRIMARY KEY (mygov_prenotazione_flusso_riconciliazione_id);


--
-- TOC entry 2923 (class 2606 OID 4116281)
-- Name: mygov_prenotazione_flusso_rendicontazione_ente mygov_prenotazione_flusso_rend_ente_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_rendicontazione_ente
    ADD CONSTRAINT mygov_prenotazione_flusso_rend_ente_pkey PRIMARY KEY (mygov_prenotazione_flusso_rendicontazione_ente_id);


--
-- TOC entry 2919 (class 2606 OID 4116283)
-- Name: mygov_prenotazione_flusso_rendicontazione mygov_prenotazione_flusso_rendicontazione_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2888 (class 2606 OID 4116259)
-- Name: mygov_segnalazione mygov_segnalazione_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_segnalazione
    ADD CONSTRAINT mygov_segnalazione_pkey PRIMARY KEY (mygov_segnalazione_id);


--
-- TOC entry 2927 (class 2606 OID 4116285)
-- Name: mygov_tipo_flusso mygov_tipo_flusso_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2929 (class 2606 OID 4116287)
-- Name: mygov_utente mygov_utente_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2869 (class 1259 OID 4116288)
-- Name: fki_mygov_ente_flusso_rend_mygov_anagrafica_stato_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_ente_flusso_rend_mygov_anagrafica_stato_id ON mygov_ente_flusso_rendicontazione USING btree (mygov_anagrafica_stato_id);


--
-- TOC entry 2870 (class 1259 OID 4116289)
-- Name: fki_mygov_ente_flusso_rend_mygov_pren_flusso_rend_ente_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_ente_flusso_rend_mygov_pren_flusso_rend_ente_id ON mygov_ente_flusso_rendicontazione USING btree (mygov_prenotazione_flusso_rendicontazione_ente_id);


--
-- TOC entry 2873 (class 1259 OID 4116290)
-- Name: fki_mygov_ente_prenotazione_mygov_ente_id_fkey; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_ente_prenotazione_mygov_ente_id_fkey ON mygov_ente_prenotazione USING btree (mygov_ente_id);


--
-- TOC entry 2876 (class 1259 OID 4116291)
-- Name: fki_mygov_ente_tipo_dovuto_mygov_ente_fkey; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_ente_tipo_dovuto_mygov_ente_fkey ON mygov_ente_tipo_dovuto USING btree (mygov_ente_id);


--
-- TOC entry 2881 (class 1259 OID 4116292)
-- Name: fki_mygov_entepsp_flusso_rend_mygov_prenotazione_flusso_rend_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_entepsp_flusso_rend_mygov_prenotazione_flusso_rend_id ON mygov_entepsp_flusso_rendicontazione USING btree (mygov_prenotazione_flusso_rendicontazione_id);


--
-- TOC entry 2882 (class 1259 OID 4116293)
-- Name: fki_mygov_entepsp_flusso_rendicontaz_mygov_anagrafica_stato_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_entepsp_flusso_rendicontaz_mygov_anagrafica_stato_id ON mygov_entepsp_flusso_rendicontazione USING btree (mygov_anagrafica_stato_id);


--
-- TOC entry 2899 (class 1259 OID 4116294)
-- Name: fki_mygov_flusso_rendicontazione_mygov_manage_flusso_id_fkey; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2920 (class 1259 OID 4116295)
-- Name: fki_mygov_prenotazione_flusso_rend_ente_mygov_anag_stato_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_prenotazione_flusso_rend_ente_mygov_anag_stato_id ON mygov_prenotazione_flusso_rendicontazione_ente USING btree (mygov_anagrafica_stato_id);


--
-- TOC entry 2921 (class 1259 OID 4116296)
-- Name: fki_mygov_prenotazione_flusso_rend_ente_mygov_ente_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_prenotazione_flusso_rend_ente_mygov_ente_id ON mygov_prenotazione_flusso_rendicontazione_ente USING btree (mygov_ente_id);


--
-- TOC entry 2916 (class 1259 OID 4116297)
-- Name: fki_mygov_prenotazione_flusso_rendic_mygov_anagrafica_stato_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_prenotazione_flusso_rendic_mygov_anagrafica_stato_id ON mygov_prenotazione_flusso_rendicontazione USING btree (mygov_anagrafica_stato_id);


--
-- TOC entry 2917 (class 1259 OID 4116298)
-- Name: fki_mygov_prenotazione_flusso_rendicontazione_mygov_entepsp_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX fki_mygov_prenotazione_flusso_rendicontazione_mygov_entepsp_id ON mygov_prenotazione_flusso_rendicontazione USING btree (mygov_entepsp_id);


--
-- TOC entry 2894 (class 1259 OID 4359306)
-- Name: idx_mygov_flusso_export_mygov_ente_id_iud; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygov_flusso_export_mygov_ente_id_iud ON mygov_flusso_export USING btree (mygov_ente_id, cod_iud);


--
-- TOC entry 2900 (class 1259 OID 4359309)
-- Name: idx_mygov_flusso_rendicontazione_mygov_ente_id_dt_reg_fkey; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygov_flusso_rendicontazione_mygov_ente_id_dt_reg_fkey ON mygov_flusso_rendicontazione USING btree (mygov_ente_id, dt_data_regolamento);


--
-- TOC entry 2913 (class 1259 OID 4116299)
-- Name: idx_mygov_manage_flusso_cod_request_token; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygov_manage_flusso_cod_request_token ON mygov_manage_flusso USING btree (cod_request_token);


--
-- TOC entry 2952 (class 1259 OID 4359302)
-- Name: idx_mygovaccdett_ipa_iud; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovaccdett_ipa_iud ON mygov_accertamento_dettaglio USING btree (cod_ipa_ente, cod_iud);


--
-- TOC entry 2889 (class 1259 OID 4116300)
-- Name: idx_mygovexprend_cod_identificativo_flusso; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovexprend_cod_identificativo_flusso ON mygov_export_rendicontazione_completa USING btree (mygov_ente_id_e, cod_identificativo_flusso_r);


--
-- TOC entry 2890 (class 1259 OID 4116301)
-- Name: idx_mygovexprend_dt_acquisizione_e; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovexprend_dt_acquisizione_e ON mygov_export_rendicontazione_completa USING btree (mygov_ente_id_e, dt_acquisizione_e);


--
-- TOC entry 2891 (class 1259 OID 4116302)
-- Name: idx_mygovexprend_dt_acquisizione_r; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovexprend_dt_acquisizione_r ON mygov_export_rendicontazione_completa USING btree (mygov_ente_id_e, dt_acquisizione_r);


--
-- TOC entry 2892 (class 1259 OID 4116303)
-- Name: idx_mygovexprend_id_univoco_versamento; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovexprend_id_univoco_versamento ON mygov_export_rendicontazione_completa USING btree (mygov_ente_id_e, cod_e_dati_pag_id_univoco_versamento_e);


--
-- TOC entry 2893 (class 1259 OID 4116304)
-- Name: idx_mygovexprend_tipo_dovuto; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovexprend_tipo_dovuto ON mygov_export_rendicontazione_completa USING btree (mygov_ente_id_e, cod_tipo_dovuto_e);


--
-- TOC entry 2934 (class 1259 OID 4359216)
-- Name: idx_mygovimpexprendtes_causale_versamento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2935 (class 1259 OID 4359217)
-- Name: idx_mygovimpexprendtes_classificazione_completezza; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2936 (class 1259 OID 4359218)
-- Name: idx_mygovimpexprendtes_codice_iud; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2937 (class 1259 OID 4359219)
-- Name: idx_mygovimpexprendtes_de_importo; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2938 (class 1259 OID 4359220)
-- Name: idx_mygovimpexprendtes_dt_data_contabile; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2939 (class 1259 OID 4359221)
-- Name: idx_mygovimpexprendtes_dt_data_esito_singolo_pagamento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2940 (class 1259 OID 4359222)
-- Name: idx_mygovimpexprendtes_dt_data_regolamento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2941 (class 1259 OID 4359223)
-- Name: idx_mygovimpexprendtes_dt_data_valuta; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2942 (class 1259 OID 4359230)
-- Name: idx_mygovimpexprendtes_id_key; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2943 (class 1259 OID 4359224)
-- Name: idx_mygovimpexprendtes_identificativo_flusso_rendicontazione; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2944 (class 1259 OID 4359225)
-- Name: idx_mygovimpexprendtes_identificativo_univoco_regolamento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2945 (class 1259 OID 4359226)
-- Name: idx_mygovimpexprendtes_identificativo_univoco_riscossione; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2946 (class 1259 OID 4359227)
-- Name: idx_mygovimpexprendtes_identificativo_univoco_versamento; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2947 (class 1259 OID 4359228)
-- Name: idx_mygovimpexprendtes_importo_totale_pagamenti; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2948 (class 1259 OID 4359229)
-- Name: idx_mygovimpexprendtes_tipo_dovuto; Type: INDEX; Schema: public; Owner: -
--
...
--
-- TOC entry 2932 (class 1259 OID 4359203)
-- Name: idx_mygovimpexprendtescompl_data_aggiornamento; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovimpexprendtescompl_data_aggiornamento ON mygov_import_export_rendicontazione_tesoreria_completa USING btree (mygov_ente_id, classificazione_completezza, dt_data_ultimo_aggiornamento);


--
-- TOC entry 2933 (class 1259 OID 4359204)
-- Name: idx_mygovimpexprendtescompl_tipo_dovuto; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_mygovimpexprendtescompl_tipo_dovuto ON mygov_import_export_rendicontazione_tesoreria_completa USING btree (mygov_ente_id, classificazione_completezza, cod_tipo_dovuto_i, cod_tipo_dovuto_e);


--
-- TOC entry 2949 (class 1259 OID 4365166)
-- Name: idxu_mygov_anagrafica_uff_cap_acc_anno_eser; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idxu_mygov_anagrafica_uff_cap_acc_anno_eser ON mygov_anagrafica_uff_cap_acc USING btree (mygov_ente_id, cod_ufficio, cod_capitolo, cod_accertamento, de_anno_esercizio);


--
-- TOC entry 2953 (class 1259 OID 4359312)
-- Name: mygov_accertamento_dettaglio_cod_iud_cod_iuv_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX mygov_accertamento_dettaglio_cod_iud_cod_iuv_idx ON mygov_accertamento_dettaglio USING btree (cod_iud, cod_iuv);


--
-- TOC entry 3001 (class 2606 OID 4359263)
-- Name: mygov_accertamento_dettaglio mygov_accertamento_dettaglio_mygov_accertamento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_accertamento_dettaglio
    ADD CONSTRAINT mygov_accertamento_dettaglio_mygov_accertamento_fkey FOREIGN KEY (mygov_accertamento_id) REFERENCES mygov_accertamento(mygov_accertamento_id);


--
-- TOC entry 3002 (class 2606 OID 4359268)
-- Name: mygov_accertamento_dettaglio mygov_accertamento_dettaglio_mygov_utente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_accertamento_dettaglio
    ADD CONSTRAINT mygov_accertamento_dettaglio_mygov_utente_fkey FOREIGN KEY (mygov_utente_id) REFERENCES mygov_utente(mygov_utente_id);


--
-- TOC entry 2997 (class 2606 OID 4169373)
-- Name: mygov_accertamento mygov_accertamento_mygov_anagrafica_stato_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_accertamento
    ADD CONSTRAINT mygov_accertamento_mygov_anagrafica_stato_id_fkey FOREIGN KEY (mygov_anagrafica_stato_id) REFERENCES mygov_anagrafica_stato(mygov_anagrafica_stato_id);


--
-- TOC entry 2998 (class 2606 OID 4169378)
-- Name: mygov_accertamento mygov_accertamento_mygov_ente_tipo_dovuto_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_accertamento
    ADD CONSTRAINT mygov_accertamento_mygov_ente_tipo_dovuto_id_fkey FOREIGN KEY (mygov_ente_tipo_dovuto_id) REFERENCES mygov_ente_tipo_dovuto(mygov_ente_tipo_dovuto_id);


--
-- TOC entry 2999 (class 2606 OID 4169383)
-- Name: mygov_accertamento mygov_accertamento_mygov_utente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_accertamento
    ADD CONSTRAINT mygov_accertamento_mygov_utente_id_fkey FOREIGN KEY (mygov_utente_id) REFERENCES mygov_utente(mygov_utente_id);


--
-- TOC entry 3000 (class 2606 OID 4359248)
-- Name: mygov_anagrafica_uff_cap_acc mygov_anagrafica_uff_cap_acc_mygov_ente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_anagrafica_uff_cap_acc
    ADD CONSTRAINT mygov_anagrafica_uff_cap_acc_mygov_ente_fkey FOREIGN KEY (mygov_ente_id) REFERENCES mygov_ente(mygov_ente_id);


--
-- TOC entry 2958 (class 2606 OID 4116322)
-- Name: mygov_ente_flusso_rendicontazione mygov_ente_flusso_rend_mygov_prenotazione_flusso_rend_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_ente_flusso_rendicontazione
    ADD CONSTRAINT mygov_ente_flusso_rend_mygov_prenotazione_flusso_rend_id_fkey FOREIGN KEY (mygov_prenotazione_flusso_rendicontazione_ente_id) REFERENCES mygov_prenotazione_flusso_rendicontazione_ente(mygov_prenotazione_flusso_rendicontazione_ente_id);


--
-- TOC entry 2959 (class 2606 OID 4116327)
-- Name: mygov_ente_flusso_rendicontazione mygov_ente_flusso_rendicontaz_mygov_anagrafica_stato_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_ente_flusso_rendicontazione
    ADD CONSTRAINT mygov_ente_flusso_rendicontaz_mygov_anagrafica_stato_id_fkey FOREIGN KEY (mygov_anagrafica_stato_id) REFERENCES mygov_anagrafica_stato(mygov_anagrafica_stato_id);


--
-- TOC entry 2960 (class 2606 OID 4116332)
-- Name: mygov_ente_flusso_rendicontazione mygov_ente_flusso_rendicontazione_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_ente_flusso_rendicontazione
    ADD CONSTRAINT mygov_ente_flusso_rendicontazione_mygov_ente_id_fkey FOREIGN KEY (mygov_ente_id) REFERENCES mygov_ente(mygov_ente_id) ON DELETE CASCADE;


--
-- TOC entry 2961 (class 2606 OID 4116337)
-- Name: mygov_ente_prenotazione mygov_ente_prenotazione_mygov_anagrafica_stato_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2962 (class 2606 OID 4116342)
-- Name: mygov_ente_prenotazione mygov_ente_prenotazione_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2963 (class 2606 OID 4116347)
-- Name: mygov_ente_tipo_dovuto mygov_ente_tipo_dovuto_mygov_ente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2965 (class 2606 OID 4116352)
-- Name: mygov_entepsp_flusso_rendicontazione mygov_entepsp_flusso_rend_mygov_prenotazione_flusso_rend_id_fke; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_entepsp_flusso_rendicontazione
    ADD CONSTRAINT mygov_entepsp_flusso_rend_mygov_prenotazione_flusso_rend_id_fke FOREIGN KEY (mygov_prenotazione_flusso_rendicontazione_id) REFERENCES mygov_prenotazione_flusso_rendicontazione(mygov_prenotazione_flusso_rendicontazione_id);


--
-- TOC entry 2966 (class 2606 OID 4116357)
-- Name: mygov_entepsp_flusso_rendicontazione mygov_entepsp_flusso_rendicontaz_mygov_anagrafica_stato_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2967 (class 2606 OID 4116362)
-- Name: mygov_entepsp_flusso_rendicontazione mygov_entepsp_flusso_rendicontazione_mygov_entepsp_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2964 (class 2606 OID 4116367)
-- Name: mygov_entepsp mygov_entepsp_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2971 (class 2606 OID 4116387)
-- Name: mygov_flusso_export mygov_flusso_export_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2972 (class 2606 OID 4116392)
-- Name: mygov_flusso_export mygov_flusso_export_mygov_manage_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2973 (class 2606 OID 4116397)
-- Name: mygov_flusso_import mygov_flusso_import_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2974 (class 2606 OID 4116402)
-- Name: mygov_flusso_import mygov_flusso_import_mygov_manage_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2975 (class 2606 OID 4116407)
-- Name: mygov_flusso_rendicontazione mygov_flusso_rendicontazione_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2976 (class 2606 OID 4116412)
-- Name: mygov_flusso_rendicontazione mygov_flusso_rendicontazione_mygov_manage_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2977 (class 2606 OID 4116417)
-- Name: mygov_flusso_tesoreria_iuf mygov_flusso_tesoreria_iuf_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2978 (class 2606 OID 4116422)
-- Name: mygov_flusso_tesoreria_iuf mygov_flusso_tesoreria_iuf_mygov_manage_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2979 (class 2606 OID 4116427)
-- Name: mygov_flusso_tesoreria_iuv mygov_flusso_tesoreria_iuv_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_flusso_tesoreria_iuv
    ADD CONSTRAINT mygov_flusso_tesoreria_iuv_mygov_ente_id_fkey FOREIGN KEY (mygov_ente_id) REFERENCES mygov_ente(mygov_ente_id) ON DELETE CASCADE;


--
-- TOC entry 2980 (class 2606 OID 4116432)
-- Name: mygov_flusso_tesoreria_iuv mygov_flusso_tesoreria_iuv_mygov_manage_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_flusso_tesoreria_iuv
    ADD CONSTRAINT mygov_flusso_tesoreria_iuv_mygov_manage_flusso_id_fkey FOREIGN KEY (mygov_manage_flusso_id) REFERENCES mygov_manage_flusso(mygov_manage_flusso_id) ON DELETE CASCADE;


--
-- TOC entry 2981 (class 2606 OID 4116437)
-- Name: mygov_flusso_tesoreria mygov_flusso_tesoreria_mygov_ente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_flusso_tesoreria
    ADD CONSTRAINT mygov_flusso_tesoreria_mygov_ente_fkey FOREIGN KEY (mygov_ente_id) REFERENCES mygov_ente(mygov_ente_id);


--
-- TOC entry 2982 (class 2606 OID 7915120)
-- Name: mygov_flusso_tesoreria mygov_flusso_tesoreria_mygov_manage_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_flusso_tesoreria
    ADD CONSTRAINT mygov_flusso_tesoreria_mygov_manage_flusso_id_fkey FOREIGN KEY (mygov_manage_flusso_id) REFERENCES mygov_manage_flusso(mygov_manage_flusso_id);


--
-- TOC entry 2983 (class 2606 OID 4116442)
-- Name: mygov_info_flusso_poste_web mygov_info_flusso_poste_web_mygov_manage_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 3003 (class 2606 OID 4359280)
-- Name: mygov_info_mapping_tesoreria mygov_info_mapping_tesoreria_mygov_manage_flusso_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_info_mapping_tesoreria
    ADD CONSTRAINT mygov_info_mapping_tesoreria_mygov_manage_flusso_fkey FOREIGN KEY (mygov_manage_flusso_id) REFERENCES mygov_manage_flusso(mygov_manage_flusso_id);


--
-- TOC entry 2984 (class 2606 OID 4116447)
-- Name: mygov_manage_flusso mygov_manage_flusso_mygov_anagrafica_stato_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2985 (class 2606 OID 4116452)
-- Name: mygov_manage_flusso mygov_manage_flusso_mygov_ente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2986 (class 2606 OID 4116457)
-- Name: mygov_manage_flusso mygov_manage_flusso_mygov_tipo_flusso_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2987 (class 2606 OID 4116462)
-- Name: mygov_manage_flusso mygov_manage_flusso_mygov_utente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2968 (class 2606 OID 4116372)
-- Name: mygov_operatore_ente_tipo_dovuto mygov_operatore_ente_tipo_dovuto_mygov_ente_tipo_dovuto_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_operatore_ente_tipo_dovuto
    ADD CONSTRAINT mygov_operatore_ente_tipo_dovuto_mygov_ente_tipo_dovuto_fkey FOREIGN KEY (mygov_ente_tipo_dovuto_id) REFERENCES mygov_ente_tipo_dovuto(mygov_ente_tipo_dovuto_id) ON DELETE CASCADE;


--
-- TOC entry 2994 (class 2606 OID 4116467)
-- Name: mygov_prenotazione_flusso_riconciliazione mygov_pren_flus_ric_mygov_anagrafica_stato_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_riconciliazione
    ADD CONSTRAINT mygov_pren_flus_ric_mygov_anagrafica_stato_fkey FOREIGN KEY (mygov_anagrafica_stato_id) REFERENCES mygov_anagrafica_stato(mygov_anagrafica_stato_id);


--
-- TOC entry 2995 (class 2606 OID 4116472)
-- Name: mygov_prenotazione_flusso_riconciliazione mygov_pren_flus_ric_mygov_ente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_riconciliazione
    ADD CONSTRAINT mygov_pren_flus_ric_mygov_ente_fkey FOREIGN KEY (mygov_ente_id) REFERENCES mygov_ente(mygov_ente_id);


--
-- TOC entry 2996 (class 2606 OID 4116477)
-- Name: mygov_prenotazione_flusso_riconciliazione mygov_pren_flus_ric_mygov_utente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_riconciliazione
    ADD CONSTRAINT mygov_pren_flus_ric_mygov_utente_fkey FOREIGN KEY (mygov_utente_id) REFERENCES mygov_utente(mygov_utente_id);


--
-- TOC entry 2991 (class 2606 OID 4116482)
-- Name: mygov_prenotazione_flusso_rendicontazione_ente mygov_prenotazione_flusso_rend_ente_mygov_ente_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_rendicontazione_ente
    ADD CONSTRAINT mygov_prenotazione_flusso_rend_ente_mygov_ente_id_fkey FOREIGN KEY (mygov_ente_id) REFERENCES mygov_ente(mygov_ente_id) ON DELETE CASCADE;


--
-- TOC entry 2992 (class 2606 OID 4116487)
-- Name: mygov_prenotazione_flusso_rendicontazione_ente mygov_prenotazione_flusso_rend_ente_mygov_tipo_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_rendicontazione_ente
    ADD CONSTRAINT mygov_prenotazione_flusso_rend_ente_mygov_tipo_flusso_id_fkey FOREIGN KEY (mygov_tipo_flusso_id) REFERENCES mygov_tipo_flusso(mygov_tipo_flusso_id);


--
-- TOC entry 2993 (class 2606 OID 4116492)
-- Name: mygov_prenotazione_flusso_rendicontazione_ente mygov_prenotazione_flusso_rend_mygov_anag_stato_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_prenotazione_flusso_rendicontazione_ente
    ADD CONSTRAINT mygov_prenotazione_flusso_rend_mygov_anag_stato_id_fkey FOREIGN KEY (mygov_anagrafica_stato_id) REFERENCES mygov_anagrafica_stato(mygov_anagrafica_stato_id);


--
-- TOC entry 2988 (class 2606 OID 4116497)
-- Name: mygov_prenotazione_flusso_rendicontazione mygov_prenotazione_flusso_rendic_mygov_anagrafica_stato_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2989 (class 2606 OID 4116502)
-- Name: mygov_prenotazione_flusso_rendicontazione mygov_prenotazione_flusso_rendicontaz_mygov_tipo_flusso_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2990 (class 2606 OID 4116507)
-- Name: mygov_prenotazione_flusso_rendicontazione mygov_prenotazione_flusso_rendicontazione_mygov_entepsp_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- TOC entry 2969 (class 2606 OID 4116377)
-- Name: mygov_segnalazione mygov_segnalazione_mygov_ente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_segnalazione
    ADD CONSTRAINT mygov_segnalazione_mygov_ente_fkey FOREIGN KEY (mygov_ente_id) REFERENCES mygov_ente(mygov_ente_id);


--
-- TOC entry 2970 (class 2606 OID 4116382)
-- Name: mygov_segnalazione mygov_segnalazione_mygov_utente_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY mygov_segnalazione
    ADD CONSTRAINT mygov_segnalazione_mygov_utente_fkey FOREIGN KEY (mygov_utente_id) REFERENCES mygov_utente(mygov_utente_id);


-- Completed on 2018-10-18 10:22:18 CEST
