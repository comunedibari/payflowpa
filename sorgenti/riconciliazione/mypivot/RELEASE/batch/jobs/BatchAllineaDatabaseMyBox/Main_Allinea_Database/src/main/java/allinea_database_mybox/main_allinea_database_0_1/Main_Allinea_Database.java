...
package allinea_database_mybox.main_allinea_database_0_1;
...
public class Main_Allinea_Database implements TalendJob {
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database = new byte[0];
		static byte[] commonByteArray_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database.length) {
					if (length < 1024
							&& commonByteArray_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database.length == 0) {
						commonByteArray_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database = new byte[1024];
					} else {
						commonByteArray_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database,
						0, length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ALLINEA_DATABASE_MYBOX_Main_Allinea_Database) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				context.directory_talend
						+ "/conf/BatchAllineaDatabaseMyBox/batchallineadatabase-properties_1.0.properties"/**
				 * 
							...
							if (row2 != null) {
								...
								if (tmp_key_tContextLoad_1 != null) {
									try {
										...
										if (key_tContextLoad_1 != null
												&& "codice_applicazione_mypay_fesp"
														.equals(key_tContextLoad_1)) {
											context.codice_applicazione_mypay_fesp = value_tContextLoad_1;
										}

										if (key_tContextLoad_1 != null
												&& "codice_applicazione_mypay_pa"
														.equals(key_tContextLoad_1)) {
											context.codice_applicazione_mypay_pa = value_tContextLoad_1;
										}

										if (key_tContextLoad_1 != null
												&& "codice_applicazione_mypivot"
														.equals(key_tContextLoad_1)) {
											context.codice_applicazione_mypivot = value_tContextLoad_1;
										}
										...
										if (key_tContextLoad_1 != null
												&& "ente_predefinito"
														.equals(key_tContextLoad_1)) {
											context.ente_predefinito = value_tContextLoad_1;
										}
				...
				tStatCatcher_1.addMessage(
						"end",
						"tFilterRow_1",
						end_Hash.get("tFilterRow_1")
								- start_Hash.get("tFilterRow_1"));
				tStatCatcher_1Process(globalMap);
							...
							try {
								...
								while (counter_tInfiniteLoop_1 > -1) {
									...
									parentContextMap_tRunJob_1
											.put("codice_applicazione_mypay_fesp",
													context.codice_applicazione_mypay_fesp);

									parentContextMap_tRunJob_1
											.put("codice_applicazione_mypay_pa",
													context.codice_applicazione_mypay_pa);

									parentContextMap_tRunJob_1
											.put("codice_applicazione_mypivot",
													context.codice_applicazione_mypivot);
									...
									allinea_database_mybox.allinea_0_1.Allinea childJob_tRunJob_1 = new allinea_database_mybox.allinea_0_1.Allinea();
									// pass DataSources
						...
						public void run() {
							...
							try {
								...
								while (counter_tInfiniteLoop_2 > -1) {
									...
									allinea_database_mybox.log_nagios_0_1.Log_Nagios childJob_tRunJob_4 = new allinea_database_mybox.log_nagios_0_1.Log_Nagios();
									// pass DataSources
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				java.io.File logConfFile_tInitLog4J_1 = new java.io.File(
						(context.directory_talend + "/conf/BatchAllineaDatabaseMyBox/log4j.xml"));
				if (!((context.directory_talend + "/conf/BatchAllineaDatabaseMyBox/log4j.xml")
						.endsWith(".xml"))
						&& !((context.directory_talend + "/conf/BatchAllineaDatabaseMyBox/log4j.xml")
								.endsWith(".properties"))) {
		...
		try {
			...
			java.io.InputStream inContext = Main_Allinea_Database.class
					.getClassLoader().getResourceAsStream(
							"allinea_database_mybox/main_allinea_database_0_1/contexts/"
...
/************************************************************************************************
 * 162554 characters generated by Talend Open Studio for Data Integration on the
 * 11 marzo 2020 12.25.41 CET
 ************************************************************************************************/
