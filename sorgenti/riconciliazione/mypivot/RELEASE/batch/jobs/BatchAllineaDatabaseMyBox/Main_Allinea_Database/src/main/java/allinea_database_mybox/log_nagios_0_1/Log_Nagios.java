...
package allinea_database_mybox.log_nagios_0_1;
...
public class Log_Nagios implements TalendJob {
	...
	public static class LOG_STATStruct implements
		...
		final static byte[] commonByteArrayLock_ALLINEA_DATABASE_MYBOX_Log_Nagios = new byte[0];
		static byte[] commonByteArray_ALLINEA_DATABASE_MYBOX_Log_Nagios = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ALLINEA_DATABASE_MYBOX_Log_Nagios.length) {
					if (length < 1024
							&& commonByteArray_ALLINEA_DATABASE_MYBOX_Log_Nagios.length == 0) {
						commonByteArray_ALLINEA_DATABASE_MYBOX_Log_Nagios = new byte[1024];
					} else {
						commonByteArray_ALLINEA_DATABASE_MYBOX_Log_Nagios = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_ALLINEA_DATABASE_MYBOX_Log_Nagios, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ALLINEA_DATABASE_MYBOX_Log_Nagios) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Log_Nagios.class.getClassLoader()
					.getResourceAsStream(
							"allinea_database_mybox/log_nagios_0_1/contexts/"
...
/************************************************************************************************
 * 86226 characters generated by Talend Open Studio for Data Integration on the
 * 11 marzo 2020 12.25.37 CET
 ************************************************************************************************/
