...
package manage_flussi_export.manage_log_0_1;
...
public class Manage_Log implements TalendJob {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				manage_flussi_export.log_nagios_0_1.Log_Nagios childJob_tRunJob_1 = new manage_flussi_export.log_nagios_0_1.Log_Nagios();
				// pass DataSources
	...
	public static class LOG_STATStruct implements
		...
		final static byte[] commonByteArrayLock_MANAGE_FLUSSI_EXPORT_Manage_Log = new byte[0];
		static byte[] commonByteArray_MANAGE_FLUSSI_EXPORT_Manage_Log = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MANAGE_FLUSSI_EXPORT_Manage_Log.length) {
					if (length < 1024
							&& commonByteArray_MANAGE_FLUSSI_EXPORT_Manage_Log.length == 0) {
						commonByteArray_MANAGE_FLUSSI_EXPORT_Manage_Log = new byte[1024];
					} else {
						commonByteArray_MANAGE_FLUSSI_EXPORT_Manage_Log = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MANAGE_FLUSSI_EXPORT_Manage_Log,
						0, length);
				strReturn = new String(
						commonByteArray_MANAGE_FLUSSI_EXPORT_Manage_Log, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MANAGE_FLUSSI_EXPORT_Manage_Log) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Manage_Log.class.getClassLoader()
					.getResourceAsStream(
							"manage_flussi_export/manage_log_0_1/contexts/"
...
/************************************************************************************************
 * 86242 characters generated by Talend Open Studio for Data Integration on the
 * 10 marzo 2020 14.54.12 CET
 ************************************************************************************************/
