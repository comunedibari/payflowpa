...
package manage_flussi_export.log_nagios_0_1;
...
public class Log_Nagios implements TalendJob {
	...
	public static class LOG_STATStruct implements
		...
		final static byte[] commonByteArrayLock_MANAGE_FLUSSI_EXPORT_Log_Nagios = new byte[0];
		static byte[] commonByteArray_MANAGE_FLUSSI_EXPORT_Log_Nagios = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_MANAGE_FLUSSI_EXPORT_Log_Nagios.length) {
					if (length < 1024
							&& commonByteArray_MANAGE_FLUSSI_EXPORT_Log_Nagios.length == 0) {
						commonByteArray_MANAGE_FLUSSI_EXPORT_Log_Nagios = new byte[1024];
					} else {
						commonByteArray_MANAGE_FLUSSI_EXPORT_Log_Nagios = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_MANAGE_FLUSSI_EXPORT_Log_Nagios,
						0, length);
				strReturn = new String(
						commonByteArray_MANAGE_FLUSSI_EXPORT_Log_Nagios, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_MANAGE_FLUSSI_EXPORT_Log_Nagios) {
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Log_Nagios.class.getClassLoader()
					.getResourceAsStream(
							"manage_flussi_export/log_nagios_0_1/contexts/"
...
/************************************************************************************************
 * 86200 characters generated by Talend Open Studio for Data Integration on the
 * 10 marzo 2020 14.54.11 CET
 ************************************************************************************************/
