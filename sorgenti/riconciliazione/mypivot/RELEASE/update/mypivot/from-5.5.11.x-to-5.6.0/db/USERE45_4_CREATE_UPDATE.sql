...
INSERT INTO mygov_tipo_flusso(mygov_tipo_flusso_id, version, cod_tipo, de_tipo, dt_creazione, dt_ultima_modifica) VALUES (nextval('mygov_tipo_flusso_mygov_tipo_flusso_id_seq'), 0, 'C', 'Flusso giornale di cassa', '2017-10-26 10:00:00', '2017-10-26 10:00:00');

DROP VIEW v_mygov_import_export_rendicontazione_tesoreria_completa;

ALTER TABLE mygov_flusso_tesoreria 
	ALTER COLUMN cod_conto DROP NOT NULL,
	ALTER COLUMN cod_id_dominio DROP NOT NULL,
	ALTER COLUMN cod_tipo_movimento DROP NOT NULL,
	ALTER COLUMN cod_causale DROP NOT NULL,
	ALTER COLUMN de_anno_documento DROP NOT NULL,
	ALTER COLUMN cod_documento DROP NOT NULL,
	ALTER COLUMN cod_bollo DROP NOT NULL,
	ALTER COLUMN de_nome DROP NOT NULL,
	ALTER COLUMN de_via DROP NOT NULL,
	ALTER COLUMN de_cap DROP NOT NULL,
	ALTER COLUMN de_citta DROP NOT NULL,
	ALTER COLUMN cod_codice_fiscale DROP NOT NULL,
	ALTER COLUMN cod_partita_iva DROP NOT NULL,
	ALTER COLUMN cod_abi DROP NOT NULL,
	ALTER COLUMN cod_cab DROP NOT NULL,
	ALTER COLUMN cod_conto_anagrafica DROP NOT NULL,
	ALTER COLUMN dt_bolletta SET NOT NULL,
  	ALTER COLUMN dt_bolletta TYPE date,
  	ALTER COLUMN dt_data_valuta_regione TYPE date;
