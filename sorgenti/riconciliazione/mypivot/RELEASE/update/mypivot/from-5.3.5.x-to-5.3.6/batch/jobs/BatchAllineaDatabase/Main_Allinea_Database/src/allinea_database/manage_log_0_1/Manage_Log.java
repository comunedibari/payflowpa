...
package allinea_database.manage_log_0_1;
...
/**
 * Job: Manage_Log Purpose: <br>
 * Description:  <br>
 * @author 
 * @version 5.6.0.20141024_1545
 * @status 
 */
public class Manage_Log implements TalendJob {
	...
	public class ContextProperties extends java.util.Properties {
		...
		public void synchronizeContext() {
			...
			if (exception != null) {
				...
				this.setProperty("exception", exception.toString());
	...
	private final String jobName = "Manage_Log";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Manage_Log.this, new Object[] { e,
	...
	public void tLog4J_2_error(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLog4J_2_onSubJobError(java.lang.Exception exception,
			String errorComponent, final java.util.Map<String, Object> globalMap)
			throws TalendException {
	...
	public void tLog4J_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				logger_tLog4J_1.error(context.descrizione);
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				parentContextMap_tRunJob_1.put("nagios_codice_applicazione",
				...
				parentContextMap_tRunJob_1.put("exception", context.exception);

				parentContextMap_tRunJob_1.put("codice", context.codice);

				parentContextMap_tRunJob_1.put("descrizione",
						context.descrizione);

				Object obj_tRunJob_1 = null;

				obj_tRunJob_1 = context.codice;
				paraList_tRunJob_1.add("--context_param codice="
						+ RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				parentContextMap_tRunJob_1.put("codice", obj_tRunJob_1);

				obj_tRunJob_1 = context.descrizione;
				paraList_tRunJob_1.add("--context_param descrizione="
						+ RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
				parentContextMap_tRunJob_1.put("descrizione", obj_tRunJob_1);

				allinea_database.log_nagios_0_1.Log_Nagios childJob_tRunJob_1 = new allinea_database.log_nagios_0_1.Log_Nagios();
				// pass DataSources
	...
	public static class LOG_STATStruct implements
		...
		final static byte[] commonByteArrayLock_ALLINEA_DATABASE_Manage_Log = new byte[0];
		static byte[] commonByteArray_ALLINEA_DATABASE_Manage_Log = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ALLINEA_DATABASE_Manage_Log.length) {
					if (length < 1024
							&& commonByteArray_ALLINEA_DATABASE_Manage_Log.length == 0) {
						commonByteArray_ALLINEA_DATABASE_Manage_Log = new byte[1024];
					} else {
						commonByteArray_ALLINEA_DATABASE_Manage_Log = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ALLINEA_DATABASE_Manage_Log, 0,
						length);
				strReturn = new String(
						commonByteArray_ALLINEA_DATABASE_Manage_Log, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ALLINEA_DATABASE_Manage_Log) {
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				tStatCatcher_1.addMessage(
						"end",
						"tLogCatcher_1",
						end_Hash.get("tLogCatcher_1")
								- start_Hash.get("tLogCatcher_1"));
				tStatCatcher_1Process(globalMap);
	...
	public void tLog4J_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				logger_tLog4J_2.error(this.getExceptionStackTrace());
	...
	public static void main(String[] args) {
		final Manage_Log Manage_LogClass = new Manage_Log();

		int exitCode = Manage_LogClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Manage_Log.class.getClassLoader()
					.getResourceAsStream(
							"allinea_database/manage_log_0_1/contexts/"
			...
			context.exception = (Object) context.getProperty("exception");
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("exception")) {
				context.exception = (Object) parentContextMap.get("exception");
			}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Manage_Log");
		}
...
/************************************************************************************************
 * 83403 characters generated by Talend Open Studio for Data Integration on the
 * March 1, 2017 9:29:13 AM CET
 ************************************************************************************************/
