...
$BODY$
   ...
   WHERE 	
     ...
     AND CASE WHEN $9 IS NOT NULL AND $9!='' THEN tes.tipo_dovuto = $9 
  	 ELSE 
     ...
     AND CASE WHEN $11 IS NOT NULL 
         ...
         END
   OFFSET CASE WHEN ($12 IS NOT NULL) THEN ($12 - 1) ELSE 0 END 
   LIMIT CASE WHEN ($13 IS NOT NULL) THEN $13 ELSE null END;
$BODY$
...
ALTER TABLE mygov_flusso_export ALTER COLUMN de_e_ente_benef_provincia_beneficiario TYPE CHARACTER VARYING(35);
ALTER TABLE mygov_export_rendicontazione_completa ALTER COLUMN de_e_ente_benef_provincia_beneficiario_e TYPE CHARACTER VARYING(35);
