...
@Stateless
public class RipartenzaDataStorageTimer extends AbstractTimer implements ITimerLocal, ITimerRemote {

	@EJB(beanName = "RipartenzaDataStorage")
	private CommandExecutorLocal RipartenzaDataStorageProxy;
	...
	public void handleTimeout(Timer timer) {
		if (!activationController.isTimerActive(this.getClass().getSimpleName()))
			return;
		// this.checkStatus();
		logger.info(this.getClass().getSimpleName() + ", calling Ripartenza Data Storage Proxy");
		RipartenzaDataStorageProxy.executeApplicationTransaction();
	}
}
