...
@MessageDriven(activationConfig =
		{@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"),
		 @ActivationConfigProperty(propertyName = "destination", propertyValue=ServiceLocalMapper.PosizioneDebitoriaErrore)},
		mappedName = ServiceLocalMapper.PosizioneDebitoriaErrore)		
public class ErroriIdpListenerBean implements MessageListener {
    ...
    public void onMessage(Message message) {
    	logger.info(this.getClass().getSimpleName() + " messaggio in arrivo da coda di errore ");
