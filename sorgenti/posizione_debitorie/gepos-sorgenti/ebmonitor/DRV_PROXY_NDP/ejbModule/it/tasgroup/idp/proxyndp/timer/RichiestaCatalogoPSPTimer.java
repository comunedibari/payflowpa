...
@Stateless
public class RichiestaCatalogoPSPTimer extends AbstractTimer implements ITimerLocal, ITimerRemote {

	@EJB(beanName = "RichiestaCatalogoPspNdp")
	private CommandExecutorLocal richiestaCatalogoPspNdpProxy;
	...
	public void handleTimeout(Timer timer) {
		if (!activationController.isTimerActive(this.getClass().getSimpleName()))
			return;
		logger.info(this.getClass().getSimpleName() + ", calling richiestaCatalogoPspNdpProxy");
		richiestaCatalogoPspNdpProxy.executeApplicationTransaction();
	}
