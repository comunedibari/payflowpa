...
@Stateless
public class ElencoFlussiRendicontazioneNdpTimer extends AbstractTimer implements ITimerLocal, ITimerRemote {

	@EJB(beanName = "RichiestaElencoRendicontazioniNdp")
	private CommandExecutorLocal richiestaElencoRendicontazioneProxy;
	...
	public void handleTimeout(Timer timer) {
		if (!activationController.isTimerActive(this.getClass().getSimpleName()))
			return;
		logger.info(this.getClass().getSimpleName() + ", calling richiestaElencoRendicontazioneProxy");
		richiestaElencoRendicontazioneProxy.executeApplicationTransaction();
	}
