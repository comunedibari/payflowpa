...
public class ElaboraDettaglioRendicontazioneNdpTimer extends AbstractTimer implements ITimerLocal, ITimerRemote {

	@EJB(beanName = "ElaboraDettaglioRendicontazioneNdp")
	private ExecutorLocal ElaboraDettaglioRendicontazioneNdpProxy;
	...
	public void handleTimeout(Timer timer) {
		...
		logger.info(this.getClass().getSimpleName()
				+ ", calling ElaboraDettaglioRendicontazioneNdpProxy");		
		ElaboraDettaglioRendicontazioneNdpProxy.executeApplicationTransaction();
	}
