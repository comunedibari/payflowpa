package it.tasgroup.idp.proxyndp.monitoring;
...
//		logger.info("Invoking method:" + context.getMethod());
	    ...
	    logger.info("MonitoringInterceptor, Invoking " + target);	
...
//	        return context.proceed();
	    	...
	    	logger.info("MonitoringInterceptor, Exiting " + target);
	        ...
	        logger.info("Business method " + businessMethodName + "in " + beanClassName + "takes " + totalTime + "ms to execute");
...
//	        MonitoringProcessiProxy.executeApplicationTransaction(monData);
			...
			logger.info("Executed (E2eMsgi-SndId-SndSys-Prodotto-TipoOp-NumRec-MexErrore-TotalTime-Esito-RcvrId-ReceiverSys) ");
