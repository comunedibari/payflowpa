 ...
 * @author gdefacci
 */
public class CollTasTestConfiguration extends SpringXml2SqlConfiguration implements PendenzeTestConfiguration {
	
	public CollTasTestConfiguration(Environment env) {
		super(env);
	}
	protected CollTasTestConfiguration(BeanFactory bf) {
		super(bf);
	}
