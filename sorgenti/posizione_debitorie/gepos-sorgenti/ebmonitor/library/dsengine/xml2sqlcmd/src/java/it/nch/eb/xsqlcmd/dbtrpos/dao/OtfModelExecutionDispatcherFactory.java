 ...
 * @author gdefacci
 */
public class OtfModelExecutionDispatcherFactory extends AbstractPendenzeOrchestratorFactory {

//	private final String opDefault;
//	private final PendenzeDBErrorsFactory errorsFactory = new PendenzeDBErrorsFactory();

	public OtfModelExecutionDispatcherFactory() {
		this(PendenzeConsts.OPERATOR_DEFAULT);
	}

	public OtfModelExecutionDispatcherFactory(String opDefault) {
