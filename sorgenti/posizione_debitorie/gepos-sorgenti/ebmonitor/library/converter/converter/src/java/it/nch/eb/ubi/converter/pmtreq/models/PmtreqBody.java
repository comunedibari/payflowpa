...
public class PmtreqBody  implements it.nch.eb.flatx.flatmodel.FilePositionProvider   {
		...
		private it.nch.eb.common.converter.pmtreq.models.RecordFIModel recordFI;
	...
	private int	lineNumber;
			...
			public it.nch.eb.common.converter.pmtreq.models.RecordFIModel getRecordFI() {
				return recordFI;
			}
		
			public void setRecordFI(it.nch.eb.common.converter.pmtreq.models.RecordFIModel recordFI) {
				this.recordFI = recordFI;
			}
