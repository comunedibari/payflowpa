 ...
 * @author gdefacci
 */
public class ParserErrorsFactory_Serializable {
	
	/* transient and lazy since cant find a way to make it serializable */
	private transient PropertyResourceBundle i18nXsdErrors;
	private final 		String	classpathLocation;
	
	public ParserErrorsFactory_Serializable(final String classpathLocation) {
