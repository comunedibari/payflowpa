...
import it.toscana.rete.cart.servizi.iris_1_1.idpinclude.TipoOperazioneUpdateStatus;


/**
 * <p>Java class for DettaglioPagamento.UpdateStatus complex type.
 * 
 ...
 *         &lt;element name="DataScadenza" type="{http://www.cart.rete.toscana.it/servizi/iris_1_1/IdpInclude}IdPDate" minOccurs="0"/>
 *         &lt;element name="DataInizioValidita" type="{http://www.cart.rete.toscana.it/servizi/iris_1_1/IdpInclude}IdPDate" minOccurs="0"/>
 *         &lt;element name="DataFineValidita" type="{http://www.cart.rete.toscana.it/servizi/iris_1_1/IdpInclude}IdPDate" minOccurs="0"/>
 *         &lt;element name="Stato" type="{http://www.cart.rete.toscana.it/servizi/iris_1_1/IdpInclude}StatoPagamento"/>
 *         &lt;element name="Importo" type="{http://www.cart.rete.toscana.it/servizi/iris_1_1/IdpInclude}Importo" minOccurs="0"/>
...
@XmlType(name = "DettaglioPagamento.UpdateStatus", propOrder = {
    "idPagamento",
    "cip",
    "dataScadenza",
    "dataInizioValidita",
...
public class DettaglioPagamentoUpdateStatus {
     ...
     * @return
     *     possible object is
     *     {@link TipoOperazioneUpdateStatus }
     *     
     */
