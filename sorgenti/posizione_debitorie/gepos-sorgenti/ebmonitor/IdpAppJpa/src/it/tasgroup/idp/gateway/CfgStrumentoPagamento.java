...
@NamedQuery(name="CfgStrumentoPagamento.findAll", query="SELECT c FROM CfgStrumentoPagamento c")
public class CfgStrumentoPagamento extends it.tasgroup.idp.domain.BaseIdEntity implements Serializable {
	...
	@GeneratedValue(
			...
			generator="cfg_strumento_pagamento_pk_gen")	
	@SequenceGenerator(
	...
	public CfgGatewayPagamento addCfgGatewayPagamento(CfgGatewayPagamento cfgGatewayPagamento) {
		...
		cfgGatewayPagamento.setCfgStrumentoPagamento(this);
	...
	public CfgGatewayPagamento removeCfgGatewayPagamento(CfgGatewayPagamento cfgGatewayPagamento) {
		...
		cfgGatewayPagamento.setCfgStrumentoPagamento(null);
