package it.tasgroup.backoffice.ente.form.monitoraggio;
...
public class RicercaMonitoraggioFlussiForm extends ValidatorActionForm{
    ...
    public void s(List<ComboOption> riceventi) {
    ...
    public Boolean checkRequiredFieldsFlussi() {
		...
		if (StringUtils.isEmpty(nomeSupporto) && StringUtils.isEmpty(dataCreazioneDa) && StringUtils.isEmpty(dataCreazioneA))
