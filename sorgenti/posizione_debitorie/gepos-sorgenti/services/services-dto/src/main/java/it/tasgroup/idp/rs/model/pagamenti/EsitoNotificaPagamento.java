 ...
 */
@XmlRootElement
public class EsitoNotificaPagamento extends RESTResource {
	...
	public EsitoNotificaPagamento(String esito, String faultCode, String faultString, String faultDescription) {
    	this.esito=esito;
