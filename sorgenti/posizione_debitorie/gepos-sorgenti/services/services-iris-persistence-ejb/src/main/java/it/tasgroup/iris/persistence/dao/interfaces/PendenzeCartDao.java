...
@Local
public interface PendenzeCartDao extends Dao<PendenzeCart>{
	
	public List<PendenzeCart> getByFilterParametersPaginated(FilterVO filter, PagingCriteria pagingCriteria, PagingData pagingData);
