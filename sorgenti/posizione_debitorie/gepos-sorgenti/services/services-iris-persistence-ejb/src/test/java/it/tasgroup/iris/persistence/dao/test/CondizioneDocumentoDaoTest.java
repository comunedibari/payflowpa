...
public class CondizioneDocumentoDaoTest  {
...
//        p.put("jdbc/iris.Password", "idp");
        p.put("jdbc/iris.JdbcUrl", "jdbc:db2://10.1.128.153:50000/IDPDB");
        p.put("jdbc/iris.UserName", "idp");
	...
	public void testListCondizioniByIdDocumentoDiPagamento() {
		...
		try {
			CondizioneDocumentoDao toTest = (CondizioneDocumentoDao) context.lookup("java:global/services-iris-persistence-ejb/CondizioniDocumentoDaoService");
		    String idDocumento = "17223";
			CondizioneDocumento cDoc =  (CondizioneDocumento) toTest.listCondizioniByIdDocumentoDiPagamento(idDocumento);
            if(cDoc == null || cDoc.getId() == null)
            	System.out.println("vuoto");
            else
            	System.out.println("CondizioneDocumento:"+cDoc.getId());
		} catch (Exception e) {
