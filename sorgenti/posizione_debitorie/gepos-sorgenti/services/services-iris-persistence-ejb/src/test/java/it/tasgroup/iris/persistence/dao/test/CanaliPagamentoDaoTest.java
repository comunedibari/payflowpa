...
public class CanaliPagamentoDaoTest{
	...
	@Test
    public void testGetByCodCanale() throws Exception{
		
		CanaliPagamentoDao toTest =(CanaliPagamentoDao) context.lookup("java:global/services-iris-persistence-ejb/CanaliPagamentoDaoService");
		
		//toTest.setEntityManager(this.getEntityManager());
		
		CanaliPagamento result = toTest.getByTipoCanale("ATM");
