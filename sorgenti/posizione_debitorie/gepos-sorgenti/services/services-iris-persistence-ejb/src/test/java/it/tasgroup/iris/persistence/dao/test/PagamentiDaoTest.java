...
public class PagamentiDaoTest {
	...
	public void testGetById()throws Exception{
	    PagamentiDao toTest =(PagamentiDao) context.lookup("java:global/services-iris-persistence-ejb/PagamentiDaoService");
        Pagamenti p =  toTest.loadById(Pagamenti.class, "10");
	}
