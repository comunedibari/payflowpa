...
public class CfgGatewayPagamentoDaoTest{
	...
	@Test
    public void TestGetByBundle() throws Exception{
		
		CfgGatewayPagamentoDao toTest =(CfgGatewayPagamentoDao) context.lookup("java:global/services-iris-persistence-ejb/CfgGatewayPagamentoDaoService");
		
		//toTest.setEntityManager(this.getEntityManager());
		
		CfgGatewayPagamento result = toTest.getCfgByBundleKey("GMCATM");
	...
	@Test
    public void testGetByApplicationIdAndSystemId() throws Exception{
		
		CfgGatewayPagamentoDao toTest =(CfgGatewayPagamentoDao) context.lookup("java:global/services-iris-persistence-ejb/CfgGatewayPagamentoDaoService");
		
		String systemId = "01030";
		String applicationId= "GMC-ATM";
		
		CfgGatewayPagamento result = toTest.getCfgBySystemIdAndApplicationId(systemId, applicationId);
