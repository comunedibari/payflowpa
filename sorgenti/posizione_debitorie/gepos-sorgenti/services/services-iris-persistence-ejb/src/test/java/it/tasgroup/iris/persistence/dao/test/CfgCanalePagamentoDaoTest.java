...
public class CfgCanalePagamentoDaoTest{
    ...
    public void TestGetByBundle() throws Exception{
		...
		CfgCanalePagamentoDao toTest =(CfgCanalePagamentoDao) context.lookup("java:global/services-iris-persistence-ejb/CfgCanalePagamentoDaoService");
			
		CfgCanalePagamento result = toTest.getCfgByBundleKey("WEB");
