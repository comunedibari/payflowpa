...
import it.tasgroup.iris.persistence.dao.CondizioniPagamentoDaoImpl;
...
public class MulteDaoTest {
	...
	@Test
	public void getMultaByTargaAndNumVerbale()throws Exception{
	    MulteDao toTest =(MulteDao) context.lookup("java:global/services-iris-persistence-ejb/MulteDaoService");
        Multe m =  toTest.getMultaByTargaAndNumVerbale("aaaa", "1010");
        if (m==null){
        	System.out.println("multa non trovata");
        }
        else{
