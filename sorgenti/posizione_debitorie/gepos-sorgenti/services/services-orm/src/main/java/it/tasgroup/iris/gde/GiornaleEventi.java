...
public class GiornaleEventi extends BaseEntity implements Serializable {
	...
	private String originalFaultCode; 
 	...
 	private String originalFaultDescription;
	...
	public void setFaultSerial(int faultSerial) {
 	...
 	@Column(name="ORI_FAULT_DESCRIPTION") 
 	public String getOriginalFaultDescription() { 
 		return originalFaultDescription; 
 	} 
 	public void setOriginalFaultDescription(String originalFaultDescription) { 
 		this.originalFaultDescription = originalFaultDescription; 
 	} 
