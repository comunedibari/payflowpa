 ...
 */
public class CtIdentificativoUnivocoPersonaFGImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.digitpa.schemas.x2011.pagamenti.CtIdentificativoUnivocoPersonaFG
{
     ...
     */
    public it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG.Enum getTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            ...
            return (it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG xgetTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG target = null;
            target = (it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG)get_store().find_element_user(TIPOIDENTIFICATIVOUNIVOCO$0, 0);
            return target;
        }
    }
     ...
     */
    public void setTipoIdentificativoUnivoco(it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG.Enum tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTipoIdentificativoUnivoco(it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersFG)get_store().add_element_user(TIPOIDENTIFICATIVOUNIVOCO$0);
            }
