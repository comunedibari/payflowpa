 ...
 */
public class CtIdentificativoUnivocoPersonaGImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.gov.digitpa.schemas.x2011.pagamenti.CtIdentificativoUnivocoPersonaG
{
     ...
     */
    public it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG.Enum getTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            ...
            return (it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG.Enum)target.getEnumValue();
        }
    }
     ...
     */
    public it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG xgetTipoIdentificativoUnivoco()
    {
        synchronized (monitor())
        {
            check_orphaned();
            it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG target = null;
            target = (it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG)get_store().find_element_user(TIPOIDENTIFICATIVOUNIVOCO$0, 0);
            return target;
        }
    }
     ...
     */
    public void setTipoIdentificativoUnivoco(it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG.Enum tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void xsetTipoIdentificativoUnivoco(it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG tipoIdentificativoUnivoco)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (it.gov.digitpa.schemas.x2011.pagamenti.StTipoIdentificativoUnivocoPersG)get_store().add_element_user(TIPOIDENTIFICATIVOUNIVOCO$0);
            }
