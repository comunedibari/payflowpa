...
public class DistintePagamentoRicercaVO implements Serializable
{ 
	...
	private String modVersamento;

	public String getModVersamento() {
		return modVersamento;
	}

	public void setModVersamento(String modelloVersamento) {
		this.modVersamento = modelloVersamento;
	}

	public DistintePagamentoRicercaVO() {super();}
	...
	public String getGruppoIntestatarioEnte() {
		return gruppoIntestatarioEnte;
	}

	public void setGruppoIntestatarioEnte(String gruppoIntestatarioEnte) {
		this.gruppoIntestatarioEnte = gruppoIntestatarioEnte;
	}
	...
	public Boolean checkRequiredFields() {
		...
		if (StringUtils.isEmpty(iuv) &&  StringUtils.isEmpty(importoPagamentoDa) &&  StringUtils.isEmpty(importoPagamentoA) && StringUtils.isEmpty(codPagamento) && StringUtils.isEmpty(idPendenza)&& StringUtils.isEmpty(idPagamento) &&  StringUtils.isEmpty(cfUtenteCreatore) && StringUtils.isEmpty(this.codFiscDebitore) && StringUtils.isEmpty(dataCreazioneAGG) && StringUtils.isEmpty(dataCreazioneAMM) && StringUtils.isEmpty(dataCreazioneAYY) && StringUtils.isEmpty(dataCreazioneDaGG) && StringUtils.isEmpty(dataCreazioneDaMM) && StringUtils.isEmpty(dataCreazioneDaYY)&& StringUtils.isEmpty(dataScadenzaGG) && StringUtils.isEmpty(dataScadenzaMM) && StringUtils.isEmpty(dataScadenzaYY))
