 ...
 * 
 */
public enum EnumCBILLPaymentStatus implements MessageDescription {
	...
	EnumCBILLPaymentStatus(String chiave, String descrizione,
			String chiaveBundle) {
		this.chiave = chiave;
	...
	public static EnumCBILLPaymentStatus getByKey(String chiave) {
		EnumCBILLPaymentStatus desiredItem = null; // Default
		for (EnumCBILLPaymentStatus item : EnumCBILLPaymentStatus.values()) {
	...
	public static EnumCBILLPaymentStatus getFromEnumStatoPagamentoCondizione(
