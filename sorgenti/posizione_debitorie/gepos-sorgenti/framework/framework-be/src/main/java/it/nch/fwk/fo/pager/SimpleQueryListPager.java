...
{ 
	...
	public DTOCollection getPagedQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm, Query  query,Query  countQuery){
		return this.getPagedQuery(pagingCriteria, sm,null,null, query, countQuery);
	}
	
	public DTOPo getSqlPagedQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm,String queryString, String countQueryString, Query  query,Query  countQuery)
	{
		...
		if (pagingCriteria!=null && pagingCriteria.getPaginationSmart() != null && pagingCriteria.getPaginationSmart().trim().equals("true")){
			dtopo =  executePagedQueryLight(pagingCriteria, sm, queryString,  countQueryString,  query,countQuery);
			...
			dtopo =  executePagedQuery(pagingCriteria, sm, queryString,  countQueryString,  query,countQuery);
			//dtoCollection = new DTOCollectionImpl((Collection)dtopo.getPersistenceObject(), true);
			//dtoCollection.setPagingData(dtopo.getPagingData());
		}
		return dtopo;
	...
	public DTOCollection getPagedQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm, 
	...
	public DTOCollection getPagedQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm, Query  query)
	{
		DTOCollection dtoCollection = null;
	...
	public DTOCollection getPagedQueryByCriteria(PagingCriteria pagingCriteria, StatelessSessionManager sm, Criteria  criteria)
	{
		DTOCollection dtoCollection = null;
		if (pagingCriteria.getPaginationSmart() != null && pagingCriteria.getPaginationSmart().trim().equals("true")){
	...
	public DTOPo getDTOPoPagedQueryByCriteria(PagingCriteria pagingCriteria, StatelessSessionManager sm,  Criteria criteria)
	{
		DTOPo dtopo = null;
		if (pagingCriteria.getPaginationSmart() != null && pagingCriteria.getPaginationSmart().trim().equals("true")){
	...
	public DTOPo getDTOPoPagedQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm,  Query  query,Query  countQuery)
	{
		DTOPo dtopo = null;
		if (pagingCriteria.getPaginationSmart() != null && pagingCriteria.getPaginationSmart().trim().equals("true")){
	...
	public DTOPo getDTOPoPagedQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm,  Query  query)
	{
		DTOPo dtopo = null;
		if (pagingCriteria.getPaginationSmart() != null && pagingCriteria.getPaginationSmart().trim().equals("true")){
	...
	private DTOPo  executePagedQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm, 
			String queryString, String countQueryString, Query  query,Query  countQuery)
	{
		...
		{
			int count = -1;
			//count = sm.count(pagingCriteria.getCountQuery());
			if (countQuery  != null)
				count = sm.count(countQuery);
...
//			TODO check this 
			...
			if(pagingCriteria.getEnablePaging()){
				...
				result = sm.createQuery(queryString);
			}
			// End Add
...
//		End Add		
	...
	private DTOPo  executePagedQueryLight(PagingCriteria pagingCriteria, StatelessSessionManager sm, 
			String queryString, String countQueryString, Query  query,Query  countQuery){
	...
	private DTOPo  executePagedQueryLightByCriteria(PagingCriteria pagingCriteria, StatelessSessionManager sm, 
	...
	private Collection  executePaginationQueryByCriteria(PagingCriteria pagingCriteria, StatelessSessionManager sm, 
	...
	private Collection  executePaginationQuery(PagingCriteria pagingCriteria, StatelessSessionManager sm, 
	...
	private Collection  executePagination(PagingCriteria pagingCriteria, StatelessSessionManager sm, 
		...
		int lastPage = -1; 
		if (countQuery  != null)
			elementsCount = sm.count(countQuery);
		else if (countQueryString != null)
			elementsCount = sm.count(countQueryString);
		else {
			//Attenzione: se il db non permette i cursori scrollabili il driver JDBC
